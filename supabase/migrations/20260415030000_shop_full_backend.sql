-- ============================================================
-- 20260415_shop_full_backend.sql
-- Shop Full-Stack: Mehrbilder + Gespeicherte + Produkt-Melden
-- ============================================================

-- ─── 1. Mehrbilder: image_urls Spalte ─────────────────────────────────────────

ALTER TABLE public.products
  ADD COLUMN IF NOT EXISTS image_urls text[] NOT NULL DEFAULT '{}';

-- get_shop_products RPC: image_urls hinzufügen
...
-- RPC: toggle_save_product → { saved: bool }
...
-- RPC: get_saved_products → Array wie get_shop_products
...
-- ─── 3. Produkt-Report (Hinweis: target_type='product' existiert bereits) ─────
-- content_reports unterstützt target_type='product' bereits.
-- create_report RPC prüfen und sicherstellen dass 'product' erlaubt ist.

-- Sicherstellen dass create_report 'product' erlaubt (idempotent):
