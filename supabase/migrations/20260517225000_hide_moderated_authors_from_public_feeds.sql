-- Hide banned and shadowbanned authors from public discovery surfaces.
--
-- Admin enforcement can now set profiles.is_banned and profiles.is_shadow_banned.
-- Public feed/detail RPCs must honor those flags so moderation action has an
-- immediate user-facing effect without waiting for app redeploys.
