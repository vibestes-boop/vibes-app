...
1. Backfill für fehlende Video-Thumbnails:
   - Erledigt am 2026-05-03.
   - 4 fehlende Video-Thumbnails wurden lokal mit ffmpeg generiert.
   - JPEGs wurden nach R2 unter `thumbnails/{userId}/...` hochgeladen.
   - `posts.thumbnail_url` wurde fuer alle 4 Kandidaten aktualisiert.
   - Werkzeug gebaut: `npm run thumbnails:backfill -- --dry-run --limit 25`.
   - Verifikation danach: `No video posts without thumbnail_url found.`
2. Bild-Backfill:
...
6. Z-Placeholder ist entschärft:
   ...
   Thumbnail-Backfill fuer die bekannten Video-Posts ohne `thumbnail_url` ist erledigt.
   Aktualisierte Posts:
   - `ada22442-031f-4485-a0ca-d133683ccd4f`
   - `7faaa080-ec41-49dd-9c06-20ca2cb912a3`
   - `7349cad1-e9d8-4c6d-836e-819307feeddf`
   - `ec83966c-4efa-4941-95fc-5db64ec63986`
   Verifikation: Feed API erste 24 Posts, `videoMissingThumbnails: 0`.
