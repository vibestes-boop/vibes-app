/**
 * lib/tracking.ts — Sendungsverfolgung-Deeplinks (DE-Markt).
 * Baut aus Carrier + Nummer die Tracking-URL des Versanddienstes.
 * Unbekannter/leerer Carrier → null (UI zeigt dann nur die kopierbare Nummer).
 */
