...
export const de = {
  ...
  tabs: {
    ...
    women_only: 'WOZ 🌸',
    profile: 'Profil',
    switchLeft: 'Linker Tab · tippen zum Wechseln',
    switchRight: 'Rechter Tab · tippen zum Wechseln',
  },
  notif: {
    title: 'Aktivität',
  ...
  profile: {
    ...
    // Follow-Liste (app/follow-list.tsx)
    followingBtn: 'Folgst',
    noFollowersYet: 'Noch keine Follower',
    followsNobody: 'Folgt noch niemandem',
  },
  analytics: {
    days: '{n} Tage',
    ...
    likes: 'Likes',
    comments: 'Kommentare',
    interactions: '{n} Interaktionen',
    engRate: 'Engagement-Rate',
    engSub: 'Likes + Kommentare ÷ Views',
    qExcellent: 'Ausgezeichnet',
    qGood: 'Gut',
    qAverage: 'Durchschnittlich',
    qLow: 'Niedrig',
    earningsSec: 'Einnahmen · {n} Tage',
    growthSec: 'Follower-Wachstum · {n} Tage',
    earningsCaps: 'EINNAHMEN',
    points: '{n} Punkte',
    earned: 'Verdient',
    giftsReceived: 'Gifts erhalten',
    payable: 'Auszahlbar',
    topGift: 'Top Gift',
    topSender: 'Top Sender',
    lastGifts: 'LETZTE GIFTS',
    fromUser: 'von @{name}',
    noGrowth: 'Noch keine Wachstums-Daten 📈',
    maxPerDay: '{n} max/Tag',
    topContent: 'Top-Inhalte',
    views: 'Aufrufe',
    viewsShort: 'Views',
    commentsShort: 'Komm.',
    postCompletion: 'Post · Abschlussrate',
    noData: 'Noch keine Post-Daten 📊',
    noDataSub: 'Erstelle Posts und interagiere mit deiner Community',
    video: 'Video',
    image: 'Bild',
  },
  shop: {
    ...
    productsCountOne: '{n} Produkt',
    productsCountMany: '{n} Produkte',
    lowStockN: 'Nur {n} übrig',
    forQuery: ' für „{q}"',
  ...
  orders: {
    ...
    extend: 'Verlängern',
    extendTitle: 'Deadline verlängern',
    extendSub: 'Bis wann soll die Runde laufen?',
    roundExtended: 'Deadline verlängert ✓',
    ...
    // GuildRoundCard
    roundShort: 'Sammelbestellung',
    roundEndsSoon: 'endet gleich',
    roundUntil: 'bis {date}',
    goalReachedShort: 'Ziel erreicht 🎉',
    beFirstRound: 'Sei die/der Erste 🌸',
    proofOne: '@{name} ist dabei',
    proofMore: '@{name} + {n} sind dabei',
    proofCount: '{n} sind dabei',
    joined: 'Dabei',
    joinRound: 'Mitbestellen',
    nOfM: '{n} von {m}',
  ...
  woz: {
    ...
    gateTitle: 'Ein Raum, der dir gehört.',
    gateSub: 'Ein geschützter Bereich nur für Frauen — technisch gesichert, nicht nur versprochen.',
    featPrivacy: 'Kein Mann sieht deine Women-Only Inhalte',
    featShare: 'Teile Videos und Live-Streams ohne Sorgen',
    featFeed: 'Ein eigener Feed nur für Frauen',
    featShop: 'Women-Only Produkte im Shop',
    reviewNote: 'Zum Schutz der Zone prüfen wir jeden Beitritt. Falsche Angaben führen zum dauerhaften Ausschluss (AGB §3).',
    join: 'Zugang beantragen',
    pendingTitle: 'Antrag in Prüfung',
    pendingSub: 'Wir schauen ihn uns kurz an — du bekommst Bescheid, sobald er freigegeben ist.',
    ...
    confirmCta: 'Ja, ich bin eine Frau',
    back: 'Zurück',
    next: 'Weiter',
    sentTitle: 'Antrag ist da 🌸',
    sentSub: 'Zum Schutz der Zone wird jeder Beitritt geprüft. Du bekommst Zugang, sobald er freigegeben ist.',
    sentStep1: 'Dein Antrag ist in Prüfung',
    sentStep2: 'Du wirst benachrichtigt, sobald er freigegeben ist',
    sentStep3: 'Danach siehst du alle Women-Only Inhalte',
    sentDone: 'Alles klar',
    blurTitle: 'Women-Only',
    blurSub: 'Nur für verifizierte Frauen',
  },
  ...
  onboarding: {
    ...
    usernameChars: 'Nur lateinische Buchstaben (a–z), Zahlen und _ erlaubt.',
    usernamePublicHint: 'Dein Username ist öffentlich sichtbar. Du kannst ihn später in den Einstellungen ändern.',
