...
// nackten Text ohne Vorschau. serlo-web.vercel.app bleibt als Alias erreichbar,
// primär ist seit Juli 2026 www.serlo.ch. Pfade müssen den Web-Routen entsprechen:
//   Post/Video → /p/<id>   (NICHT /post/)
//   Produkt    → /shop/<id>
//   Profil     → /u/<username>
// -----------------------------------------------------------------------------

export const WEB_BASE = 'https://www.serlo.ch';
