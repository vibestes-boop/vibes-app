...
const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('flex flex-col gap-1.5 border-b border-border px-6 py-4 text-center sm:text-left', className)}
    {...props}
  />
);
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      'flex flex-col-reverse border-t border-border px-6 py-4 sm:flex-row sm:justify-end sm:space-x-2',
      className,
    )}
    {...props}
  />
