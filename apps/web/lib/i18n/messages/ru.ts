...
const ruMessages = {
  ...
  landing: {
    ...
    shopSub: 'Масляный парфюм, хендмейд и другое от людей, на которых ты подписан(а).',
    shopAll: 'Все товары',
    ...
    betaBadge: 'Уже в App Store',
    heroTitle: 'Эфиры. Магазин. Комьюнити.',
    heroSubtitle: 'Создано для твоего комьюнити.',
    heroText:
      'Смотри эфиры, открывай видео и заказывай парфюм напрямую у людей из твоего комьюнити. Бесплатно в браузере и в приложении.',
    ...
    vpStreamerDesc:
      'Игровые стримы, IRL-шоу, ток-форматы. Мульти-источники: демонстрация экрана, вебкамера и микрофон, или напрямую из OBS.',
