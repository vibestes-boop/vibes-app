...
const ruMessages = {
  ...
  landing: {
    ...
    liveLabel: 'Эфир',
    trendingLabel: 'Обзор',
    shopLabel: 'Маркетплейс',
    shopTitle: 'Настоящие товары из комьюнити',
    shopSub: 'Масляный парфюм, хендмейд и другое — напрямую от людей, на которых ты подписан(а).',
    shopAll: 'Все товары',
    featuresLabel: 'Почему Serlo',
    featuresTitle: 'Создано для стримеров, продавцов и авторов',
    ctaTitle: 'Serlo должен быть у тебя в кармане',
    ctaText: 'Видео, эфиры и маркетплейс — бесплатно в App Store.',
    streamsLiveOne: '1 стрим сейчас в эфире',
    streamsLiveMany: '{count} стримов сейчас в эфире',
    betaBadge: 'Новое — Serlo уже в App Store',
    heroTitle: 'Эфиры. Магазин. Комьюнити.',
    heroSubtitle: 'Создано для твоего комьюнити.',
    heroText:
      'Смотри эфиры, открывай видео и заказывай парфюм и другое — напрямую у людей из твоего комьюнити. Бесплатно: в браузере и в приложении.',
    getApp: 'Или скачай приложение для iPhone',
    scanQr: 'Наведи камеру телефона',
    appStoreAlt: 'Загрузить в App Store',
