...
const deMessages = {
  ...
  // Feed (feed-card / feed-list / home-feed-shell)
  feed: {
    // Tabs / Shell
    forYou: "Für dich",
    followingTab: "Folge ich",
    friends: "Freunde",
    sourcesAria: "Feed-Quellen",
    feedAria: "Feed",
    welcome: "Willkommen auf Serlo!",
    welcomeHint:
      "Folge anderen Accounts — dein Feed füllt sich dann automatisch mit Content, der zu dir passt.",
    followingEmptyHint: "Folge anderen Accounts, um ihren Content hier zu sehen.",
    loadError: "Feed konnte nicht geladen werden",
    emptyTitle: "Noch keine Posts",
    emptyHereTitle: "Noch keine Posts hier.",
    emptyHereHint: "Schau in /explore rein oder folge neuen Accounts.",
    newPosts: "Neue Posts",
    ...
    playPauseAria: "Video pausieren / abspielen",
    pipLabel: "Schwebender Player",
    pipUnsupported: "Dein Browser unterstützt das nicht.",
    pipUnavailable: "Schwebender Player nicht verfügbar.",
    downloadVideo: "Video herunterladen",
    music: "Musik",
    originalSound: "Original-Sound",
    profileOfAria: "Profil von @{username} öffnen",
    followAria: "Folgen",
    commentsDisabled: "Kommentare deaktiviert",
    commentsClose: "Kommentare schließen",
    commentsOpenAria: "Kommentare öffnen — {count} Kommentare",
    shareCountAria: "Teilen — {count} mal geteilt",
    saved: "Gespeichert",
    save: "Merken",
    unsaveAria: "Aus Merkliste entfernen",
    saveAria: "Zur Merkliste hinzufügen",
    reposted: "Repostet",
    repost: "Reposten",
    unrepostAria: "Repost entfernen",
    repostAria: "Post reposten",
    // Karten-Menü / Caption-Edit
    edit: "Bearbeiten",
    editCaption: "Caption bearbeiten",
    captionPlaceholder: "Was möchtest du teilen?",
    captionSaved: "Caption aktualisiert.",
    saveFailed: "Speichern fehlgeschlagen.",
    saving: "Speichere…",
    // Tastatur-Hilfe
    prevVideoAria: "Vorheriges Video (K)",
    nextVideoAria: "Nächstes Video (J)",
    shortcutsAria: "Tastaturkürzel anzeigen",
    kbdNext: "Nächstes",
    kbdPrev: "Vorheriges",
    kbdLike: "Like",
    kbdMute: "Stumm",
  ...
  landing: {
    ...
    vpCreatorDesc:
      "Desktop-Creator-Studio mit Scheduled Posts, Cloud-Drafts, Peak-Hours-Heatmap und Watch-Time-Analytics. Mehr Kontrolle als im Native-App.",
    discoverCreators: "Creator entdecken",
    noLoginNeeded: "Klick auf einen Account — kein Login nötig",
  ...
  notif: {
    ...
    dm: "{name} hat dir eine Nachricht geschickt.",
    giftNamed: "{name} hat dir {emoji} {gift} gesendet.",
    gift: "{name} hat dir ein Geschenk gesendet.",
    preorderNamed: "{name} hat „{product}“ vorbestellt 🌸",
    preorder: "{name} hat ein Produkt vorbestellt 🌸",
    savedNamed: "{name} hat „{product}“ gemerkt 🔖",
    savedGeneric: "{name} hat dein Produkt gemerkt 🔖",
    roundOpenNamed: "Sammelbestellung läuft: „{product}“ 🌸",
    roundOpen: "Eine Sammelbestellung ist offen 🌸",
    orderUpdateNamed: "Update zu „{product}“",
    orderUpdate: "Update zu deiner Bestellung",
    liveNow: "{name} ist jetzt live.",
    liveInvite: "{name} hat dich zum Duett eingeladen.",
    followRequest: "{name} möchte dir folgen.",
    followAccepted: "{name} hat deine Follower-Anfrage angenommen.",
    boughtNamed: "{name} hat „{product}“ gekauft.",
    bought: "{name} hat ein Produkt bei dir gekauft.",
    commentLike: "{name} hat deinen Kommentar geliked.",
    repost: "{name} hat deinen Post geteilt.",
    storyReaction: "{name} hat auf deine Story reagiert.",
    guildActivity: "Neue Aktivität in deiner Guild.",
    supportReplyQuoted: "Antwort vom Team: „{text}“",
    supportReply: "Das Team hat auf deine Support-Anfrage geantwortet 💬",
    supportNewQuoted: "Neue Support-Anfrage: „{text}“",
    supportNew: "{name} hat eine neue Support-Anfrage gestellt 🆘",
    genericActivity: "Neue Aktivität von {name}.",
  },
