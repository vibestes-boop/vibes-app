...
const enMessages = {
  ...
  settings: {
    ...
    rowMutedHostsLabel: 'Muted live hosts',
    rowMutedHostsSubtitle: 'Manage go-live notifications',
    rowCohostBlocksLabel: 'Co-host block list',
    rowCohostBlocksSubtitle: 'Who can join as co-host',
    rowCreatorStudioLabel: 'Creator Studio',
    rowCreatorStudioSubtitle: 'Revenue, analytics, top posts',
    ...
    rowWozSubtitle: 'Verify to access Women-Only content',
    ...
    rowChangeEmailSubtitle: 'Confirmation sent to new address',
    ...
    securityEmailSuccess: 'Confirmation email sent — please check your inbox.',
    securityPasswordPlaceholder: 'New password (min. 8 chars)',
