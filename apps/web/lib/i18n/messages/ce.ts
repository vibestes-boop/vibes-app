...
const ceMessages = {
  ...
  settings: {
    ...
    rowMutedHostsLabel: 'Мукъ ца хиллачу эфираш',
    rowMutedHostsSubtitle: 'Go-Live хаамаш нисъяр',
    rowCohostBlocksLabel: 'Ко-хост блок-лист',
    rowCohostBlocksSubtitle: 'Мила со-хост хила тарло',
    rowCreatorStudioLabel: 'Creator Studio',
    rowCreatorStudioSubtitle: 'Доходаш, аналитика, топ-посташ',
    rowCreatorActivateLabel: 'Creator хила ✦',
    rowCreatorActivateSubtitle: 'Мегийна · Схьагора · Монетизаци',
    ...
    rowWozSubtitle: 'Верификаци де Women-Only контентана гӀорах',
    rowWozActiveSubtitle: 'Хьан Women-Only контентана гӀо ду',
    rowWozActiveBadge: 'Жигар ✓',
    sectionSecurity: 'Аккаунт кхерамазалла',
    rowChangeEmailLabel: 'Email хийца',
    rowChangeEmailSubtitle: 'Кхачам билгалдан кехат тӀехь адресе',
    rowChangePasswordLabel: 'Пароль хийца',
    rowChangePasswordSubtitle: 'КӀеззиг 8 башха',
    securityEmailPlaceholder: 'керла@email.com',
    securityEmailSubmit: 'Email хийца',
    securityEmailSubmitting: 'Дохуш…',
    securityEmailSuccess: 'Кхачам билгалдан кехат дехьадели — почта хьажа.',
    securityPasswordPlaceholder: 'Керла пароль (кӀеззиг 8 башха)',
    securityPasswordConfirmPlaceholder: 'Пароль нийса хийца',
    securityPasswordSubmit: 'Пароль хийца',
    securityPasswordSubmitting: 'Лоцуш…',
    securityPasswordSuccess: 'Пароль хийцина.',
    securityPasswordMismatch: 'Парольш цхьатера бац.',
    securityPasswordTooShort: 'КӀеззиг 8 башха деза.',
    securityCancel: 'ДӀадита',
