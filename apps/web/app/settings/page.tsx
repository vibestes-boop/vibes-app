...
export default async function SettingsOverviewPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl">
      ...
      {/* Sektion 1c — KI-Stimme (v1.w.UI.217) */}
      <Section label="KI-Stimme">
        <SettingsRow
          icon={Mic}
          label="Meine KI-Stimme"
          subtitle={
            (profile as unknown as { voice_sample_url?: string | null } | null)?.voice_sample_url
              ? '✓ Stimme gespeichert — Chatterbox spricht wie du'
              : 'Stimme aufnehmen (5–15 Sek.)'
          }
          href={'/settings/voice' as Route}
