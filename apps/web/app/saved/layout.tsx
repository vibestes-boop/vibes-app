...
// -----------------------------------------------------------------------------
// /saved (Gespeichert) layout — persistente FeedSidebar auf Desktop (xl+), damit die Seite
// dieselbe Orientierung/Navigation hat wie /explore, /people, /guilds, /u.
// Vorher: kein layout.tsx → keine Sidebar → Seite ohne Navigations-Kontext.
// -----------------------------------------------------------------------------

export default async function SavedLayout({ children }: { children: ReactNode }) {
