...
export const metadata = {
  title: 'Explore — Trending auf Serlo',
  description: 'Entdecke Trending-Hashtags, beliebte Videos und Top-Creator auf Serlo.',
};

export default async function ExplorePage() {
  const [hashtags, preview] = await Promise.all([
    ...
    <main className="container mx-auto max-w-6xl px-4 py-8">
      <header className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Was auf Serlo gerade abgeht — Hashtags, Themen, Accounts.
        </p>
      </header>
      ...
      <section className="mb-12">
        ...
        {hashtags.length === 0 ? (
          <p className="text-sm text-muted-foreground">
            Keine aktiven Hashtags — schau in ein paar Tagen wieder rein.
          </p>
        ) : (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="truncate text-xs text-muted-foreground">
                      {formatCount(h.post_count)} Posts · {formatCount(h.total_views)} Views
                    </div>
                  </div>
