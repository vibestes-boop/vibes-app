...
// -----------------------------------------------------------------------------
// /u layout — Profile-Pages mit persistenter FeedSidebar auf Desktop (xl+).
//
// Auf der Profilseite sollte der User dieselbe linke Navigation sehen wie im
// Home-Feed. Deshalb nutzt dieses Layout dasselbe Sidebar-Pattern wie
// HomeFeedShell — aber ohne rechte Discovery-Sidebar (nur im Feed-Kontext).
// -----------------------------------------------------------------------------
...
export default async function UserLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-[1600px]">
      {/* Left Sidebar — nur auf xl+ sichtbar, identisch zum Home-Feed */}
