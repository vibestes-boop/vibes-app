...
- **🔴 OFFENE PUNKTE (nach Priorität):**
  ...
  5. ✅ **Web-Sammelbestellungs-Karte LIVE** (Commit `339a6cd`, Migration `20260716110000_active_preorder_round_public` ausgeführt 16.7.). `serlo.ch/shop/[id]` + `/shop` zeigen die laufende Fireside-Runde jetzt auch anonymen WhatsApp-Neukunden — anon verifiziert (Accessibility-Baum + SSR-HTML: „Sammelbestellung läuft · 1 von 80 reserviert"). 🔴 **ABER: `preorder_rounds.closes_at` der Fireside-Runde ist 2026-07-04 (abgelaufen, Status noch `open`) → Karte zeigt „Endet gleich".** Vor dem WhatsApp-Push verlängern: `UPDATE preorder_rounds SET closes_at='2026-07-25T21:59:00+00:00' WHERE id='85f98436-e11f-48bc-a9fa-3a7b2e348ca3';` (Round-ID = Fireside).
