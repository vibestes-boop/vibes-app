...
| **DB-Migrationen** | 🔴 **OFFEN: `20260716100000_live_sessions_woz_rls_fix`** (WOZ-Live-Leak — Zaur im SQL-Editor ausführen, danach Anon-Probe s. Zeile drunter). Davor alle ausgeführt (zuletzt Session 12: shop_banners_ru, profiles_locale, seller_accounts_rls). |
