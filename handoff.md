...
- **🔴 OFFENE PUNKTE (nach Priorität):**
  ...
  4. ✅ **Binary-Build ERLEDIGT (11.7.): v1.31.0 Build 292** gebaut + per Auto-Submit zu ASC hochgeladen (Commit `ed125a0`). Einzige native Neuerung seit 291: `expo-localization` (Gerätesprache nativ). ⚠️ Der frühere Grund „Editor-Compositing" war VERALTET — view-shot-Compositing + TEXT-Modus sind seit 1.29.0 im Binary. **Zaur:** in ASC Version 1.31.0 anlegen/„Was ist neu" ausfüllen, ggf. TestFlight-Kurztest, einreichen. ⚠️ **OTA-Runtime ist ab jetzt 1.31.0** — dringende Fixes für 1.30.0-Bestandsnutzer brauchen temporären Version-Rollback in app.json + Doppel-Publish.
...
| **App Store** | 🎉 **LIVE**: https://apps.apple.com/app/serlo/id6760790424 (Build 291, v1.30.0). **Build 292 (v1.31.0) am 11.7. zu ASC hochgeladen** (expo-localization nativ) — wartet auf Zaurs ASC-Einreichung. Teilbarer Link: **`https://www.serlo.ch/app`**. |
